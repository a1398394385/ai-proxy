...
class TestAnthropicToChat(unittest.TestCase):
    ...
    def test_simple_text_message(self):
        ...
        from proxy.transform import anthropic_to_chat
        body = {
    ...
    def test_redacted_thinking_produces_empty_reasoning(self):
        """redacted_thinking block → reasoning_content: ""（无法提取原文，用空字符串占位）。"""
        from proxy.transform import anthropic_to_chat
        body = {
            "model": "claude-sonnet-4-6",
            "messages": [
...
class TestAnthropicSSEStream(unittest.TestCase):
    ...
    def test_message_start(self):
        ...
        from proxy.transform import create_anthropic_sse_stream
        sse = (
...
class TestChatToAnthropic(unittest.TestCase):
    ...
    def test_basic_text_response(self):
        ...
        from proxy.transform import chat_to_anthropic
        response = {
            "id": "chatcmpl-123",
            "model": "qwen3.6-plus",
            "choices": [{
